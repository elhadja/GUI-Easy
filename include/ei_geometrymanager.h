 ...
 *  Modified by Bah elhadj amadou and Rémi
 *
 */
...
protected:
    /**
     * @brief actualize_size actualize the size of the widget relative to his parent
     * @param widget the widget to actualize the size
     * this function use absolute and relative size of the widget to determine the new size in the screen
     */
    void actualize_size(ei::Widget* widget);
    /**
     * @brief actualize_pos actualize the position of a widget relative to his parent
     * @param widget the widget to actualize the position
     * this function use absolute position and relative position of a widget and calculate
     * the new current position of the widget
     */
    void actualize_pos(ei::Widget* widget);
